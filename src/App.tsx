...
const works = [
  ...
  },
  {
    ...
    body: "A clinic app for doctors and assistants: appointments, digital prescriptions, and patient records on a phone, instead of paper, WhatsApp, and handwritten scripts.",
    meta: "Healthcare Platform · Sr. UI/UX Designer · 3 weeks",
    tags: [
      "Doctor Interviews",
      "Clinic Workflows",
      "Mobile UX",
    ...
    teaser: "Doctors and assistants run the clinic from a phone: appointments, prescriptions, and records.",
  },
  {
    id: "epix",
...
function WorkVisual({ type }: { type: (typeof works)[number]["visual"] }) {
  const shots: Partial<Record<(typeof works)[number]["visual"], { src: string; alt: string; contain?: boolean }>> = {
    saas: { src: "/assets/hero-aha-saas.png?v=4", alt: "AHA SaaS Proposal Management on a laptop", contain: true },
